...
#sed -i 's/Package xmlns="http:\/\/soap.sforce.com\/2006\/04\/metadata"/Package/g' $WSPACE/manifest/package.xml
																																																																																																				                                ...
																																																																																																				                                echo Generating new member for $ENTITY
																																																																																																								                                xmlstarlet ed -L -s "/Package/types[name='$TYPENAME']" -t elem -n members -v "$ENTITY" $WSPACE/manifest/package.xml
																																																																																																																						...
																																																																																																																						echo Cleaning up Package.xml
																																																																																																																								...
																																																																																																																								#sed -i 's/<Package>/<Package xmlns="http:\/\/soap.sforce.com\/2006\/04\/metadata">/g' $WSPACE/manifest/package.xml
